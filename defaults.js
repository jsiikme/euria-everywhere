...
var EURIA_STRINGS = {
  fr: {
    ...
    optSave: "Enregistrer",
    optSaved: "Enregistré ✓",
    optProductHint: "Le numéro de votre produit AI Services (ex. 12345). Pour l'obtenir : curl -H \"Authorization: Bearer VOTRE_JETON\" https://api.infomaniak.com/1/ai — le champ « id » de la réponse.",
  ...
  en: {
    ...
    optSave: "Save",
    optSaved: "Saved ✓",
    optProductHint: "Your AI Services product number (e.g. 12345). To get it: curl -H \"Authorization: Bearer YOUR_TOKEN\" https://api.infomaniak.com/1/ai — the \"id\" field of the response.",
